...
export default function Register() {
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center p-6 lg:p-12 mt-16 ${
    ...
    >
      ...
      <div
        className={`w-full lg:w-1/2 space-y-4 rounded-lg border ${
          theme === "dark" ? "border-gray-700" : "border-gray-300"
        } px-6 lg:px-20 py-8 lg:py-10 shadow-lg`}
      >
